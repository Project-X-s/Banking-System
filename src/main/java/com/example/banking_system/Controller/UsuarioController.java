...
import com.example.banking_system.DTO.UsuarioRequestDTO;
import com.example.banking_system.DTO.UsuarioSelectedDTO;
import com.example.banking_system.Exception.NotFoundException;
import com.example.banking_system.Mapper.UsuarioMapper;
import com.example.banking_system.Module.User;
import com.example.banking_system.Repository.UsuarioRepository;
...
public class UsuarioController {
    ...
    public ResponseEntity<Object> cadastrar(@RequestBody @Valid UsuarioRequestDTO usuarioRequestDTO) {
        ...
        try {
            User usuario = UsuarioMapper.toModel(usuarioRequestDTO);
    ...
    public ResponseEntity<List<?>> listarTodos() {
        ...
        try {
            List<User> listaTodosUsuarios = usuarioRepository.findAll();
            ...
            for (User usuario : listaTodosUsuarios) {
                methodsOn(usuario);
    ...
    private void methodsOn(User usuario) {
